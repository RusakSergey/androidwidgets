...
private const val DEFAULT_MARKER_WIDTH = 50
...
class ColorRatingWidget @JvmOverloads constructor(
    ...
    private var markerWidth: Int = DEFAULT_MARKER_WIDTH
        set(value) {
            field = value
            initMarkers(field)
        }
    ...
    private fun initMarkers(markerWidth: Int) {
        ...
        positionMarkerArray = IntArray(quantity) { i -> markerWidthWithSpace * i + marginBetween }
